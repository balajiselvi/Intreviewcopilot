...
export function selectSapComponents(question = "", analysis = {}, isHybrid = false) {
  ...
  // itself. The literal word "SAP" is checked nowhere else in the entire classification
  // pipeline. This is the narrowest possible addition -- one proper noun, not a keyword list --
  // and was verified absent from every required non-technical control question before being
  // added (see Problem B Phase 3 matrix).
