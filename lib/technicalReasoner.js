...
// Behavioral/PMP/Leadership are not SAP-technical categories -- mirrors the same guard already
// applied in componentSelector.js's step-4 fallback. That fix alone was incomplete: this
// function has its OWN independent PFCG/SU24 default (below) that re-injects the exact same
// fabricated-relevance components whenever it receives an empty sapComponents array, regardless
// of why that array is empty. Confirmed live: the componentSelector.js fix made
// selectSapComponents() correctly return [] for a PMP question, but the final prompt still
// showed "Components: PFCG, SU24..." because of this second fallback.
