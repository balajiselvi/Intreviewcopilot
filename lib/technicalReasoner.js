...
const CATEGORY_REASONING = Object.freeze({
  ...
  RISE: {
    ...
    governanceConsideration: "Customer owns IAS tenant policy/trust, IPS jobs, IAG/GRC rulesets, and S/4 PFCG. SAP owns the hyperscaler/private-cloud operations boundary. IAS still authenticates only."
  },
  "S/4": {
