...
const CATEGORY_REASONING = Object.freeze({
  ...
  RISE: {
    ...
    governanceConsideration: "Customer owns IAS tenant policy/trust, IPS jobs, IAG/GRC rulesets, and S/4 PFCG. On-premise Cloud Connector is always customer- or partner-operated on customer infrastructure — never say SAP owns or operates the Cloud Connector. Other RISE operating-model details follow the contract. SAP owns the hyperscaler/private-cloud operations boundary, not the customer's role catalog or SoD ruleset. IAS still authenticates only."
  },
  "S/4": {
