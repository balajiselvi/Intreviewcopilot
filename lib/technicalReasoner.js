...
const CATEGORY_REASONING = Object.freeze({
  ...
  RISE: {
    ...
    governanceConsideration: "Customer owns IAS tenant policy/trust, IPS jobs, IAG/GRC rulesets, S/4 PFCG, and the on-premise Cloud Connector they operate. SAP owns the hyperscaler/private-cloud operations boundary, not the customer's role catalog or SoD ruleset. IAS still authenticates only."
  },
  "S/4": {
