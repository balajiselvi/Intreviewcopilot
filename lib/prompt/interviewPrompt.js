...
7. End with a clear recommendation or principle grounded in your reasoning. Never add a generic closing line like "That's the architectural pattern," "This improves compliance," or "This enhances governance" unless it states something genuinely new.
...
Before finalizing, silently verify: the first sentence answers the question and shows architect thinking; at least one SAP component mentioned (unless purely conceptual); no idea repeats; no sentence could be cut without losing technical value; it sounds spoken by a peer, not written documentation; trade-offs or business context clear; any ownership claim is grounded in CANDIDATE BACKGROUND. Correct it internally — output only the corrected answer, never the check itself.`
  ...
  if (category === "Behavioral" || analysis.isBehavioral) {
    backgroundContext.push(
      `BEHAVIORAL QUESTION DIRECTIVE: Frame this as a specific personal experience ("I remember a situation where...", "On one project I managed..."). Start with the real scenario, explain what you did, and describe the actual outcome. Ground the answer in CANDIDATE BACKGROUND. If CANDIDATE BACKGROUND is not provided, use knowledge-framing: "A common approach is..." or "Best practice shows..."`
    );
  }
