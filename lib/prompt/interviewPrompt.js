...
const CATEGORY_TEMPLATES = Object.freeze({
  ...
  Troubleshooting: "Structure: Real Problem Pattern → Root Cause Analysis → Step-by-Step Resolution (with T-codes/transactions) → Preventive Monitoring → Next Troubleshooting Steps.",
  ...
  Hypercare: "Structure: Post-Go-Live Context (Week 1-2) → Dedicated Team Structure → Incident Management (P1/P2/P3 SLAs, response times) → Knowledge Transfer Plan → Escalation Procedures → Monitoring Tools (ST03/SM21/SU53).",
  Behavioral: "Structure: Specific Scenario (what happened, business context) → Your Action (what you actually did, decisions made) → Real Outcome (measurable result, business impact) → Learning/Reflection (why it worked, what changed).",
...
- Reference cloud infrastructure security: data residency, encryption, network architecture
- Include SAP cloud services security (IPS, analytics cloud, extension modules)
- Add API security and serverless function authorization
