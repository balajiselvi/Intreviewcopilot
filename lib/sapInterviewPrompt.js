...
SAP Domain: ${analysis.domain || ""}

Industry: ${analysis.industry || ""}

Business Process: ${analysis.businessProcess || ""}

Complexity: ${analysis.complexity || ""}

Interviewer Intent: ${analysis.interviewerIntent || ""}`
...
`Use the retrieved enterprise SAP knowledge below as the PRIMARY technical reference.

Instructions

• Prefer retrieved implementation evidence.

• Combine multiple relevant sources.

• Complete gaps using enterprise SAP best practices.
