...
// Per-record follow-up prioritization. v1 (PHASE2_ENGINEERING_MEMORY_CALIBRATION.md, n=3 real
// answers): lesson_learned missing 3/3, ownership missing 3/3 -- tied, lesson_learned listed
// first. v2 (10-answer self-learning-protocol session, n=10 real answers): ownership missing
// 10/10 vs. lesson_learned missing 6/10 -- a stronger, cleaner signal at 3x the sample size
// revised the ranking, not just confirmed it. Ownership moved to top priority. Still a pure
// acquisition-behavior reorder -- section 2's Judgment Record schema is unchanged.
