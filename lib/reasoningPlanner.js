...
const REQUIRED_ELEMENTS_BY_MODE = Object.freeze({
  ...
  resolve: [
    ...
    "If CANDIDATE BACKGROUND does not contain a matching incident, stay in methodology voice — never invent a ticket, employer, or 'recent scenario' to sound experienced."
  ],
  lead: [
