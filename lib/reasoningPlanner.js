...
const REQUIRED_ELEMENTS_BY_MODE = Object.freeze({
  ...
  design: [
    "Open with the architectural decision the interviewer is testing — not a requirements workshop or stakeholder-gathering tour.",
...
const TECHNICAL_DEPENDENCY_ELEMENT =
  "Name the plane-correct technical dependencies in the spoken answer: T-code plus table or authorization object for ABAP, GRC, or Fiori backend; trust, job, role collection, scope, or log for IAS, IPS, IAG, or BTP. Use only what this question's plane requires. Do not invent names. Do not dump an inventory. Do not paste ABAP T-codes onto a cloud-only question.";
