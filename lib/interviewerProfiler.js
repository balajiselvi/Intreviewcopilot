  ...
  constructor(config = {}) {
    ...
    this.interviewerCatalog = {
      architect: {
        ...
        patterns: /(architecture|landscape|integration|design|framework|blueprint|platform|scalability|microservices|cloud native)/i,
        weight: 1.0,
        technicalDepth: 0.95,
      ...
      securityLead: {
        ...
        patterns: /(authorization|role|pfcg|su24|su25|grc|ara|arm|eam|firefighter|risk management|access control)/i,
        weight: 0.95,
        technicalDepth: 0.9,
      ...
      supportLead: {
        ...
        patterns: /(issue|error|troubleshoot|su53|st01|st22|dump|trace|problem|incident|outage|root cause)/i,
        weight: 0.85,
        technicalDepth: 0.85,
      ...
      deliveryManager: {
        ...
        patterns: /(project|stakeholder|delivery|team|deadline|budget|resource|governance|leadership|timeline|milestone)/i,
        weight: 0.8,
        technicalDepth: 0.6,
      ...
      executive: {
        ...
        patterns: /(strategy|roadmap|future|vision|digital transformation|value|business case|competitive|market|innovation)/i,
        weight: 0.9,
        technicalDepth: 0.7,
      ...
      auditor: {
        ...
        patterns: /(audit|sox|compliance|control|risk assessment|evidence|regulatory|governance controls)/i,
        weight: 0.85,
        technicalDepth: 0.7,
        architectureWeight: 0.4,
